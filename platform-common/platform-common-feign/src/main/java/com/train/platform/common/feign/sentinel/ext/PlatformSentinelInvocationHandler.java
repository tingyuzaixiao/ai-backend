 ...
 */
@Slf4j
public class PlatformSentinelInvocationHandler implements InvocationHandler {
	...
	PlatformSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			PlatformSentinelInvocationHandler other = (PlatformSentinelInvocationHandler) obj;
