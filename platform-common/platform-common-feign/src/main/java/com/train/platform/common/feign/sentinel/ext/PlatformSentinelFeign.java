...
package com.train.platform.common.feign.sentinel.ext;
 ...
 * @date 2024/6/9
 */
public final class PlatformSentinelFeign {

	private PlatformSentinelFeign() {

	}

	public static PlatformSentinelFeign.Builder builder() {
		return new PlatformSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public PlatformSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new PlatformSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new PlatformSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new PlatformSentinelInvocationHandler(target, dispatch);
				}
