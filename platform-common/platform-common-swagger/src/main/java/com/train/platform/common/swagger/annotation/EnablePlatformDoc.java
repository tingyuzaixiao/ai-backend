...
package com.train.platform.common.swagger.annotation;

import com.train.platform.common.core.factory.YamlPropertySourceFactory;
import com.train.platform.common.swagger.config.OpenAPIDefinitionImportSelector;
import com.train.platform.common.swagger.support.SwaggerProperties;
...
public @interface EnablePlatformDoc {
