...
public class PlatformResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public PlatformBearerTokenExtractor platformBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new PlatformBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new PlatformCustomOpaqueTokenIntrospector(authorizationService);
	}
