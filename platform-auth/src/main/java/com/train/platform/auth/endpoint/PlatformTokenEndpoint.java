...
package com.train.platform.auth.endpoint;
...
import com.train.platform.admin.api.entity.SysOauthClientDetails;
import com.train.platform.admin.api.feign.RemoteClientDetailsService;
import com.train.platform.admin.api.vo.TokenVo;
...
import com.train.platform.common.core.util.RetOps;
import com.train.platform.common.core.util.SpringContextHolder;
import com.train.platform.common.security.annotation.Inner;
import com.train.platform.common.security.util.OAuth2EndpointUtils;
import com.train.platform.common.security.util.OAuth2ErrorCodesExpand;
import com.train.platform.common.security.util.OAuthClientException;
...
public class PlatformTokenEndpoint {
	...
	private final AuthenticationFailureHandler authenticationFailureHandler = new PlatformAuthenticationFailureEventHandler();
	...
	public R<Boolean> deleteToken(@RequestBody String[] accessTokens) {
